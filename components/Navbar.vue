    ...
    <div class="h-full flex items-center gap-2 sm:gap-4 lg:gap-8">
      <NuxtLink
        ...
        :class="[
          ...
          'select-none px-1 sm:px-2 py-1 text-white cursor-pointer focus:outline-none focus-visible:outline  focus-visible:outline-white transition-colors duration-300 ease-in-out',
        ]"
