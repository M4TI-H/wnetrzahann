  ...
  <section class="flex-1 flex flex-col items-center p-4 md:p-8">
    ...
    >
      ...
      <button
        ...
        class="relative w-full py-2 md:py-3 cursor-pointer bg-neutral-800 hover:bg-black text-sm md:text-base text-gray-100 border-2 border-gray-100 hover:border-black ring-2 ring-black transition-colors duration-300 ease-in-out disabled:opacity-70"
      >
        <div
